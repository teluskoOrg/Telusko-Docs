...
![List_and_Arrays](https://dyz1pdcuffwr5.cloudfront.net/Python/list_array.png)
...
![Arrays_in_Python](https://dyz1pdcuffwr5.cloudfront.net/Python/array_python.png)
...
![Array](https://dyz1pdcuffwr5.cloudfront.net/Python/array_index.png)
