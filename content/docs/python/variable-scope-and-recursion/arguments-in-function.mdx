...
![Default_Arguments](https://dyz1pdcuffwr5.cloudfront.net/Python/default_argument_python.png)
...
![Variable_Length_Arguments](https://dyz1pdcuffwr5.cloudfront.net/Python/variable_length_arguments_python.png)
...
![Keyword_Variable_Length_Arguments](https://dyz1pdcuffwr5.cloudfront.net/Python/keyword_length_arguments_python.png)
