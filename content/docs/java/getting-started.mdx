...
![java basic](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/01-java-basic.png)
...
![operators](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/02-operators.png)
...
![control-flow](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/03-control-flow.png)
...
![arrays](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/04-arrays.png)
...
![Methods and Constructors](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/05-methods-constructor.png)
...
![class and object](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/06-class-object.png)
...
![encapsulation](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/07-encapsulation.png)
...
![inheritance](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/08-inheritence.png)

## 09 — Polymorphism

Mastering compile-time and runtime polymorphism, method binding, and achieving dynamic behavior in Java programs.
![polymorhphism](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/09-polymorhphism.png)
...
![abstraction-Interface](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/10-abstraction-interface.png)
...
![inner class](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/11-inner-class.png)
...
![enum - annotation](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/12-enum-annotation.png)
...
![string](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/13-string.png)
...
![java util](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/14-java-util.png)
...
![exception](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/15-exception.png)
...
![colletion](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/16-collection.png)

## 17 — Stream API

Using streams for functional programming, filtering, mapping, reducing, sorting, and working with parallel execution.
![stream api](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/17-stream-api.png)
...
![collection-internal](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/18-collection-internal.png)
...
![Concurrency Advanced](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/19-concurrency.png)


## 20 — JVM Internals

Understanding JVM architecture, class loading, JIT compilation, garbage collectors, memory leaks, and performance tuning.
![JVM Internals](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/20-jvm.png)


## 21 — NIO

Learning buffers, channels, selectors, asynchronous IO, and high-performance file handling used in scalable systems.
![NIO](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/21-nio.png)
...
![Modern Java](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/22-modern-java.png)


## 23 — File Handling

Reading and writing files, buffered streams, serialization, deserialization, and handling external data effectively.
![File Handling](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/23-file-handling.png)
...
![Design Patterns](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/24-design-pattern.png)

## 25 — Testing

Unit testing with JUnit, mocking with Mockito, and understanding the fundamentals of test-driven development.
![Testing](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/25-testing.png)


## 26 — Build Tools

Learning project automation and dependency management using Maven and Gradle.
![Build tools](https://dyz1pdcuffwr5.cloudfront.net/Java/getting-started/26-build-tool.png)
